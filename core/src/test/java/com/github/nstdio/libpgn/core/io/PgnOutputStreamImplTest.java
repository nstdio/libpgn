...
import static com.github.nstdio.libpgn.core.Game.Result.DRAW;
import static com.github.nstdio.libpgn.core.pgn.builder.GameBuilder.gameBuilder;
...
public class PgnOutputStreamImplTest {
    ...
    static Stream<GameAndExpected> resultStream() {
        return Stream.of(
                ...
                GameAndExpected.of(
                        new Game(null, singletonList(MoveText.ofWhite(1, "e4")), Game.Result.WHITE),
                        "1. e4 1-0"
                ),
                GameAndExpected.of(
                        new Game(null, singletonList(MoveText.ofWhite(1, "e4")), Game.Result.BLACK),
                        "1. e4 0-1"
                ),
                GameAndExpected.of(
                        new Game(null, singletonList(MoveText.ofWhite(1, "e4")), Game.Result.UNKNOWN),
                        "1. e4 *"
                )
        );
    }
