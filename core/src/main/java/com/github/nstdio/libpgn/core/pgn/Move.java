...
import static com.github.nstdio.libpgn.core.internal.ArrayUtils.EMPTY_BYTE_ARRAY;
import static com.github.nstdio.libpgn.core.internal.ArrayUtils.EMPTY_SHORT_ARRAY;
import static com.github.nstdio.libpgn.core.pgn.MoveFactory.Holder.IMMUTABLE;
import static com.github.nstdio.libpgn.core.pgn.MoveFactory.Holder.MUTABLE;
...
public interface Move {
    ...
    static Move of(byte[] move, byte[] comment) {
        return of(move, comment, EMPTY_SHORT_ARRAY);
    }
    ...
    static Move of(byte[] move) {
        return of(move, EMPTY_BYTE_ARRAY);
    }
    ...
    static Move of(String move, List<MoveText> variations) {
        return of(move.getBytes(), EMPTY_BYTE_ARRAY, EMPTY_SHORT_ARRAY, variations);
    }
    ...
    static Move of(String move, short[] nag) {
        return of(move.getBytes(), EMPTY_BYTE_ARRAY, nag, Collections.emptyList());
    }
    ...
    static Move of(String move, String comment, List<MoveText> variations) {
        return of(move.getBytes(), comment.getBytes(), EMPTY_SHORT_ARRAY, variations);
    }
    ...
    static Move ofImmutable(byte[] move, byte[] comment) {
        return ofImmutable(move, comment, EMPTY_SHORT_ARRAY);
    }
    ...
    static Move ofImmutable(byte[] move) {
        return ofImmutable(move, EMPTY_BYTE_ARRAY);
    }
